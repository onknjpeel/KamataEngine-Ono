...
void SplashEffect::Initialize(Model* model, Vector3 position, Vector3 velocity) {
	assert(model);
	model_ = model;
...
void SplashEffect::Draw(Camera& camera) { model_->Draw(worldTransform_, camera, &objectColor_); }